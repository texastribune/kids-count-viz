...
un_yr = subset(subset(raw_un, TimeFrame >= 2000), TimeFrame < 2012)
un_child = subset(subset(raw_child, TimeFrame >= 2000), TimeFrame < 2012)
...
write.csv(full_data, "../poverty-unemployment")
